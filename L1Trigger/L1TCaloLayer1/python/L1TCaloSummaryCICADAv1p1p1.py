...
L1TCaloSummaryCICADAv1p1p1 = cms.EDProducer('L1TCaloSummary_CICADA_vXp1p1',
    ...
    CICADAModelVersion = cms.string("CICADA/CICADAModel_v1p1p1"),
    ...
    testPatterns = cms.VPSet(
        ...
        # Test Pattern 2: Vivado_HLS result: 10.1719
        cms.PSet(
        ...
        # Test Pattern 3: Vivado_HLS result: 10.1719
        cms.PSet(

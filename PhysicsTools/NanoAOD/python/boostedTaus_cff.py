...
#Boosted correction stuff
#these elements can be added into the common boosted tau sequence for correction.
from RecoTauTag.Configuration.boostedHPSPFTaus_cff import ca8PFJetsCHSprunedForBoostedTaus
ca8PFJetsCHSprunedForBoostedTausPAT = ca8PFJetsCHSprunedForBoostedTaus.clone(
                        src=cms.InputTag("packedPFCandidates"),
                        jetCollInstanceName = cms.string('subJetsForSeedingBoostedTausPAT')
                )
cleanedSlimmedTausBoosted = cms.EDProducer("PATBoostedTauCleaner",
...
"""
setattr(process, "cleanedSlimmedTausBoosted", cleanedSlimmedTausBoosted)
...
finalBoostedTaus = cms.EDFilter("PATTauRefSelector",
                                src = cms.InputTag("slimmedBoostedTausNewID"),
                                #src = cms.InputTag("slimmedTausBoosted"),
...
eras.run2_miniAOD_80XLegacy.toModify(boostedTauTable,
...
boostedTauSequence = cms.Sequence(ca8PFJetsCHSprunedForBoostedTausPAT + cleanedSlimmedTausBoosted + finalBoostedTaus)
_boostedTauSequence80X =  cms.Sequence(finalBoostedTaus)
eras.run2_miniAOD_80XLegacy.toReplaceWith(boostedTauSequence,_boostedTauSequence80X)
